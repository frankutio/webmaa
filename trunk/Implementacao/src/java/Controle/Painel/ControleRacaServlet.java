...
public class ControleRacaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (operacao == null || operacao.equals("RacaLista")) {
            ...
            boolean especie = Boolean.parseBoolean(request.getParameter("raca"));
            ...
            if (msgErro.equals("")) {
                ...
                raca.setEspecie(raca.isEspecie());
            ...
            if (msgErro == null || msgErro.equals("")) {
                ...
                editarRacas.setEspecie(raca.isEspecie());
