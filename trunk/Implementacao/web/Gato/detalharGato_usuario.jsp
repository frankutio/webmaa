...
<div id="colunaLeft_geral">
          ...
          <div id="dadosInicio"> 
              ...
              <table class="grid">
                	<tr>
                    	<td width="8%"><img src="/WebMAATeste/Gato/images/miniaturas/ico_gato.png" alt="gato" title="gato" /></td>
              ...
              <tr>
                    ...
                    <tr>
                    	<td width="47%" align="right">2Âª Cor: &nbsp;</td>
                        <td width="53%"><span style="color:#000;">
                             <c:forEach items="${lstCor}" var="lstCor">
      ...
      <div align="center">
               ...
               <!-- FIM DOS DETALHES -->
                ...
                <div id="comentario">
                <br />
                <c:if test="${DetalharAnimal.localAnimal == 'Sim'}">
                ...
                <c:if test="${DetalharAnimal.localAnimal == 'Nao'}">
               ...
               <div style="width:90%;" align="right">
               		<img src="/WebMAATeste/images/botao/bt_voltar.png" alt="Voltar" title="Voltar" class="seta_link" onclick="window.location='/WebMAATeste/listaAnimal?operacao=lista_gato';" />
               </div>
                <!-- FIM DO COMENTARIO -->
           </div>
            <!-- FIM DA TELA 01 -->         
