...
<c:forEach items="${lstAnimal}" var="lstAnimal">
         ...
         <div class="listaAnimal">
               <span>
               <a href="/WebMAATeste/listaAnimal?operacao=detalhar_gato&codigo=${lstAnimal.codigo}"><img src="/WebMAATeste/${lstAnimal.especie}/images/miniaturas/${lstAnimal.endFoto}" alt="${lstAnimal.nome}" title="${lstAnimal.nome}" class="seta_link" /></a>
               </span>
                ${lstAnimal.descricao}
                <br />
                <br />
                <c:if test="${lstAnimal.localAnimal == 'Nao'}">
                    <div class="obrigatorio"> <img src="/WebMAATeste/images/ico_canil.png" alt="Em Canil" /> &nbsp; Animal em nosso Gatil e est� garantido pela Ong.</div>
                </c:if>
