...
<div id="colunaLeft_geral">
            ...
            <!-- FOTO DO USUARIO -->            
            <div id="foto">
            	<img src="/WebMAATeste/${AnimalEdita.especie}/images/miniaturas/${AnimalEdita.endFoto}" />
            </div>
            <!-- FOTO -->
...
<table class="grid">                	
            ...
            <div align="center">
                        ...
                        <a href="PainelControle?operacao=exibirPainel&colaborador=${Colaborador.codigo}"><img src="/WebMAATeste/Painel_controle/Usuario/images/botao/bt_cancelar.png" alt="Cancelar" title="Cancelar" class="seta_link" id="cancelar" onmouseover="focoBt('cancelar');" onmouseout="bt('cancelar');" /></a>
