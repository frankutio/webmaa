             ...
             <div class="bordaFaixaLeft"><span>Doação</span></div>
               ...
               <table class="grid">
                   <c:if test="${empty listaAnimal}">
                    ...
                    <a href="/WebMAATeste/Painel_controle/Usuario/cad_animal.html"><img src="/WebMAATeste/Painel_controle/Usuario/images/botao/bt_doar.png" alt="Cadatrar Animal Para Doação" title="Cadatrar Animal Para Doação" class="seta_link" id="doar" onmouseover="focoBt('doar');" onmouseout="bt('doar');" /></a></td>
                 </tr>
                   </c:if>
                   <c:if test="${!empty listaAnimal}">
                       <tr>
...
<div id="boxes">
			<!-- Janela Modal com caixa de diálogo (ALTERAR FOTO)-->  
                    ...
                    <!-- Janela Modal com caixa de diálogo (CENTRO DE MENSAGENS)-->  
					...
					<!-- Fim Janela Modal com caixa de diálogo (CENTRO DE MENSAGENS) -->
  						...
  						<div class="cont_modal">
                            ...
                            <!-- DETALHES DA MENSAGEM -->
                                <div id="conteudoDetalhe">
                                    ...
                                    <p>
                                    	Nesta tela � possivel a altera��o dos dados ou ate mesmo a exclus�o de animais cadastrados por Voc�.
                                    </p>
