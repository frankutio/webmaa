                ...
                <table class="grid" style="width:80%;">
                    ...
                    <c:forEach items="${Animais}" var="Animal">
                        <tr class="td_escura">
                            ...
                            <td align="center"><a href="/WebMAATeste/gerProcesso?operacao=detalhar_processo&cod_animal=${Animal.codigo}"><img src="/WebMAATeste/Painel_controle/Usuario/images/botao/bt_exibir.png" align="Exibir" title="Exibir" class="seta_link botaoExibir" /></a></td>
                        </tr>
                   </c:forEach>
                </table>
