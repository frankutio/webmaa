                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <div class="lista">
                                ...
                                <form id="frmanimais" action="/WebMAA/ControleAnimaisServlet" method="post">
                                        ...
                                        <div id="dadosGerais" class="abaEsconde">
                                            <table class="grid" style="width:100%;">
                                                <tr>
                                                    ...
                                                    <td colspan="3"><input type="radio" name="especie" value="false"/> Gato &nbsp; &nbsp; <input type="radio" name="especie" value="true" /> Cachorro</td>
                                                </tr>
                                                <tr>
                 ...
                 <!-- ABA DADOS COMPLEMENTARES -->
                                        <div id="dadosComplementares" class="abaEsconde">
                                              <table class="grid" style="width:100%;">
                                                    ...
                                                    <tr class="mostra" id="doses">
                                                        <td align="right">Especifique as Doses:</td>
                                                        <td><textarea rows="3" cols="75"></textarea></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input type="text" class="valortaxa" size="8" /></td>
                                                    </tr>
                                                </table>
                                           <br />
