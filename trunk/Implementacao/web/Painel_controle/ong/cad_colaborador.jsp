                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <div class="lista">
                                ...
                                <form id="frmcolaborador" action="/WebMAA/ControleColaboradorServlet" method="post">
                                   ...
                                   <fieldset>
                                        ...
                                        <table class="grid">
                                            ...
                                            <tr>
                                                ...
                                                <td width="48%"><label>Masculino &nbsp; <input type="radio" name="sexo" value="true" id="masc" /></label> &nbsp;&nbsp; <label>Feminino &nbsp; <input type="radio" name="sexo" value="false" id="femi" /></label></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div align="right" style="width:90%;">
                                        ...
                                        <!--img src="images/botao/bt_cadastrar.png" alt="Cadastrar" title="Cadastrar" class="seta_link" id="cadastrar" onmouseover="focoBt('cadastrar');" onmouseout="bt('cadastrar');" /-->
                                    </div>
                                </form>
                            </div>
