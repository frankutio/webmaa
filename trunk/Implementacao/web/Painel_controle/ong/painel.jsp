                                    ...
                                    <fieldset>
                                        ...
                                        <table style="width:100%;">
                                            <tr>
                                                ...
                                                <td>Existem <font style="color:#F00;">02</font> Animais Pendentes.</td>
                                            </tr>
                                            <tr>
                                                <td align="right" colspan="2"><img src="/WebMAA/Painel_controle/ong/images/botao/bt_exibir.png" alt="Exibir" title="Exibir" class="seta_link" id="exibir" onmouseover="focoBt('exibir');" onmouseout="bt('exibir');" onclick="window.location='relatorio_animal_pendente.jsp';" /></td>
                                            </tr>
                                        </table>
                                    </fieldset>
                                </div>
                                ...
                                <div style="float:left; width:250px; min-height:80px; margin-left:10px;">
                                    ...
                                    <fieldset>
                                        ...
                                        <table style="width:100%;">
                                            <tr>
                                                <td valign="top"><img src="/WebMAA/Painel_controle/ong/images/botao/alert.png" /></td>
                                                <td>Existem <font style="color:#F00;">03</font> Animais em fase de Adoção.</td>
                                            </tr>
                                            <tr>
                                                <td align="right" colspan="2"><a href="gerencia_adocao.jsp"><img src="images/botao/bt_exibir.png" alt="Exibir" title="Exibir" class="seta_link" id="exibir2" onmouseover="focoBt('exibir2');" onmouseout="bt('exibir2');" /></a></td>
                                            </tr>
                                        </table>
                                    </fieldset>
                                </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <table style="width:100%;">
                                            <tr>
                                                ...
                                                <td width="89%" valign="bottom"><span class="obrigatorio">33</span> Solicitação(s) em Aberto</td>
                                            </tr>
                                            <tr>
                                                <td align="right" colspan="2"><a href="gerencia_doacao.jsp"><img src="images/botao/bt_exibir.png" alt="Exibir" title="Exibir" class="seta_link" id="exibir3" onmouseover="focoBt('exibir3');" onmouseout="bt('exibir3');" /></a></td>
                                            </tr>
                                        </table>
                                    </fieldset>
                                </div>
