<%-- 
    Document   : pesquisar_animal
    Created on : 02/10/2009, 17:07:57
    Author     : usuario
--%>
    ...
    <body>
        ...
        <div id="corpo">
                            ...
                            <div class="lista">
                                ...
                                <div id="filtro">
                                    ...
                                    <div align="right" style="width:90%;">
                                        ...
                                        <img src="images/botao/bt_pesquisar.png" alt="Pesquisar" title="Pesquisar" class="seta_link" id="pesquisa" onmouseover="focoBt('pesquisa');" onmouseout="bt('pesquisa');" onclick="pesquisaAnimal();" />
                                    </div>
                                ...
                                <div id="resultAnimal" class="esconde">
                                    ...
                                    <table class="grid" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">Ong Amigos Fieis</td>
                                            <td align="center"><img src="images/botao/zoom.png" alt="Detalhar" title="Detalhar" class="seta_link" onclick="mostra('filtro','detalharCanil');" /></td>
                                            <td align="center"><img src="images/botao/document_edit.png" alt="Alterar" title="Alterar" class="seta_link" onclick="mostra('filtro','alterar'); mostrar('dadosGerais');" /></td>
            ...
            <!-- DADOS DO ANIMAL -->
                                    ...
                                    <div align="right" style="width:90%;">
                                        <img src="images/botao/bt_voltar.png" alt="Voltar" title="Voltar" class="seta_link" onclick="mostra('detalhar','filtro'); mostrar('resultAnimal');" />&nbsp;&nbsp;
                                    </div>
                                    ...
                                    <div id="cont_aba" style="padding-left:nome;">
                                        ...
                                        <div id="dadosGerais" class="abaEsconde">
                                            ...
                                            <div align="right" style="width:90%;">
                                                ...
                                                <img src="images/botao/bt_avancar.png" alt="Proximo" title="Avançar" class="seta_link" onclick="contAba('dadosComplementares','dadosC');" />
                                            </div>
                 ...
                 <!-- ABA DADOS COMPLEMENTARES -->
                                        <div id="dadosComplementares" class="abaEsconde">
                                            ...
                                            <div align="right" style="width:90%;">
                                                ...
                                                <img src="images/botao/bt_avancar.png" alt="Proximo" title="Avançar" class="seta_link" onclick="contAba('dadosObservacao','obs');" />
                                            </div>
                 ...
                 <!-- ABA OBSERVAÇÃO -->
                                        <div id="dadosObservacao" class="abaEsconde">
                                            ...
                                            <div align="right" style="width:90%;">
                                                ...
                                                <img src="images/botao/bt_alterar.png" alt="Alterar" title="Alterar" class="seta_link" id="altera" onmouseover="focoBt('altera');" onmouseout="bt('altera');" onclick="alert('Cadastro Alterado Com Sucesso.'); mostra('detalhar','filtro'); mostrar('resultAnimal');" />
                                            </div>
                                    ...
                                    <div align="right" style="width:90%;">
                                        <img src="images/botao/bt_cancelar.png" alt="Cancelar" title="Cancelar" class="seta_link" id="cancelar" onmouseover="focoBt('cancelar');" onmouseout="bt('cancelar');" onclick="mostra('detalhar','filtro'); mostrar('resultAnimal');" />&nbsp;&nbsp;
                                    </div>
            ...
            <!-- DADOS DO ANIMAL -->
                                    ...
                                    <div align="right" style="width:90%;">
                                        <img src="images/botao/bt_voltar.png" alt="Voltar" title="Voltar" class="seta_link" onclick="mostra('detalharColab','filtro'); mostrar('resultAnimal_colab');" />&nbsp;&nbsp;
                                    </div>
                 ...
                 <!-- ABA OBSERVAÇÃO -->
                                        <div id="dadosObservacao_usr" class="abaEsconde">
                                            ...
                                            <div align="right" style="width:90%;">
                                                ...
                                                <img src="images/botao/bt_alterar.png" alt="Alterar" title="Alterar" class="seta_link" id="altera2" onmouseover="focoBt('altera2');" onmouseout="bt('altera2');" onclick="alert('Cadastro Alterado Com Sucesso.'); mostra('detalharColab','filtro'); mostrar('resultAnimal_colab');" />
                                            </div>
                                    ...
                                    <div align="right" style="width:90%;">
                                        <img src="images/botao/bt_cancelar.png" alt="Cancelar" title="Cancelar" class="seta_link" id="cancelar" onmouseover="focoBt('cancelar');" onmouseout="bt('cancelar');" onclick="mostra('detalharColab','filtro'); mostrar('resultAnimal_colab');" />&nbsp;&nbsp;
                                    </div>
