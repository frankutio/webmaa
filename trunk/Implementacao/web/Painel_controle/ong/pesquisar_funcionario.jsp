                                            ...
                                            <tr>
                                               ...
                                               <td align="center">${lstFuncionario.codigo}</td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <img src="images/botao/zoom.png" alt="Detalhar" title="Detalhar" class="seta_link" onclick="mostra('filtro','detalhar');" /></a></td>
                                                <td align="center">
                                                    
                                                    <img src="/WebMAA/Painel_controle/ong/images/botao/document_edit.png" alt="Alterar" title="Alterar" class="seta_link" onclick="mostra('','alterar');alterar(${lstFuncionario.codigo});" /></td>
                                                <td align="center">
            ...
            <!-- ALTERAR DADOS -->
                                ...
                                <c:if test="${editarFuncionario.codigo != 0 || mostrarFuncionario.codigo == 0}">
                                    ...
                                    <!--div class="nota_destaque" style="width:100%;">Alteração de Dados Cadastrais</div-->
                                        <form id="frmeditarFuncionario" action="/WebMAA/ControleFuncionarioServlet" method="post" >
                                        ...
                                        <fieldset>
                                            ...
                                            <table class="grid">
                                                <tr>
                                                    <td align="right">Cod:&nbsp; </td>
                                                    <td colspan="3"><input type="text" name="cod" size="5" value="${editarFuncionario.codigo}" disabled="true" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right">Data de Cadastro:&nbsp; </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select>
                                                            <option selected="selected">Auxiliar</option>
                                        ...
                                        <div align="right" style="width:100%;">
                                            ...
                                            <!--img src="/WebMAA/Painel_controle/ong/images/botao/bt_alterar.png" alt="Alterar" title="Alterar" class="seta_link" id="altera" onmouseover="focoBt('altera');" onmouseout="bt('altera');" onclick="window.alert('Dados Alterados com Sucesso.'); mostra('alterar','filtro'); mostrar('resultado');" /-->
                                        </div>
                                     </form>
                                </div>
                                <!-- ALTERAR DADOS -->
