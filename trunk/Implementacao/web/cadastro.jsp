	...
	<!-- CONTEUDO AQUI -->
		<div id="cont">
            ...
            <div class="nota_destaque_Alert">
            	<img src="/WebMAATeste/images/botao/atencao.png" alt="Atencao" title="Atenção"  /> &nbsp;&nbsp;
            ...
            <div style="width:50%; text-align:right;">
            	<input type="image" src="/WebMAATeste/images/botao/bt_continuar.png" alt="ok" title="Continuar" id="continuar" onmouseover="focoBt('continuar');" onmouseout="bt('continuar');" disabled="disabled" />
            </div>  
