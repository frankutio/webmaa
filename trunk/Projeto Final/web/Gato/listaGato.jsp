...
<c:forEach items="${lstAnimal}" var="lstAnimal">
         ...
         <div class="listaAnimal">
               <span>
               <a href="/WebMAA/listaAnimal?operacao=detalhar_gato&codigo=${lstAnimal.codigo}"><img src="/WebMAA/${lstAnimal.especie}/images/miniaturas/${lstAnimal.endFoto}" alt="${lstAnimal.nome}" title="${lstAnimal.nome}" class="seta_link" /></a>
               </span>
                ${lstAnimal.descricao}
                <br />
                <br />
