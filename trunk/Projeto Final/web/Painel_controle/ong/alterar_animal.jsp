    ...
    <head>
        ...
        <script type="text/javascript">
            function pesquisar() {
                ...
                window.location = "/WebMAA/ControleAnimaisServlet?operacao=AnimaisProcessaPesquisa&localAnimal=" + document.getElementById("tipoL").value +"&tipoAnimal="+document.getElementById("tipoA").value ;
                mostrar('dadosGerais');
            }
                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <form id="frmeditaanimais" action="/WebMAA/ControleAnimaisServlet" method="post">
                                <input type="hidden" name="operacao" value="AnimaisEditaProcessa">
                            ...
                            <div align="right" style="width:90%;">
                                <a href="javascript:pesquisar();">
                                    <img src="/WebMAA/Painel_controle/ong/images/botao/bt_cancelar.png" alt="Cancelar" title="Cancelar" class="seta_link" id="cancelar" onmouseover="focoBt('cancelar');" onmouseout="bt('cancelar');" onclick="mostra('alterar','filtro'); mostrar('resultAnimal');" />&nbsp;&nbsp;
                                </a>
                            </div>
