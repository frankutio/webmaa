                        ...
                        <div class="lista">
                            ...
                            <div id="notificar" class="esconde">
                                <div class="bordaFaixaLeft" style="width:100%; ">
                                    <span>Gerenciar Doações - Notificaçãos</span>
                                </div>
                                <br />
                                ...
                                <div align="right">
                                    <a href="javascript:document.getElementById('frmNotificacao').submit();">
                                        <img src="/WebMAA/Painel_controle/ong/images/botao/bt_enviar.png" alt="Enviar" title="Enviar" class="seta_link close" id="enviar" onmouseover="focoBt('enviar');" onmouseout="bt('enviar');" onclick="mostra('notificar','');alert('Notificação Enviada Com Sucesso!');" />&nbsp;&nbsp;
                                    </a>
