                        ...
                        <div class="lista">
                            ...
                            <div id="filtro">
                                ...
                                <div align="right" style="width:90%;">
                                    ...
                                    <img src="/WebMAA/Painel_controle/ong/images/botao/bt_pesquisar.png" alt="Pesquisar" title="Pesquisar" class="seta_link" id="pesquisa" onmouseover="focoBt('pesquisa');" onmouseout="bt('pesquisa');" onclick="mostra('','rel_colab_fila');" />
                                </div>
                                    ...
                                    <input type="hidden" name="tipoA" id="tipoA" value="<%out.print(session.getAttribute("tipoAnimal"));%>">
                                        <table class="grid">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="localAnimal" disabled="disabled">
                                                            <option value=""></option>
                            ...
                            <div id="rel_colab_fila" class="esconde" >
                                ...
                                <table class="grid" style="width:100%;">
                                    ...
                                    <tr class="td_escura">
                                        ...
                                        <td align="center"><img src="/WebMAA/Painel_controle/ong/images/botao/document_edit.png" alt="Alterar" title="Alterar" class="seta_link" onclick="mostra('filtro','alterar_colab'); mostrar('dadosGerais_usr');" /></td>
            ...
            <!-- DADOS DO ANIMAL -->
                                ...
                                <table class="grid" style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="23%" align="center">JosÃ© Sicrano</td>
                                ...
                                <div id="confNote" class="esconde" style="color:#060;">
                                    <img src="/WebMAA/Painel_controle/ong/images/botao/aprova.png" />&nbsp;&nbsp; NotificaÃ§Ã£o Enviada Com Sucesso!
                                </div>
                                <br />
                                <br />
                 ...
                 <!-- ABA OBSERVAÃ‡ÃƒO -->
                                    <div id="dadosObservacao_usr" class="abaEsconde">
                                        ...
                                        <div align="right" style="width:90%;">
                                            ...
                                            <img src="/WebMAA/Painel_controle/ong/images/botao/bt_alterar.png" alt="Alterar" title="Alterar" class="seta_link" id="altera" onmouseover="focoBt('altera');" onmouseout="bt('altera');" onclick="alert('Cadastro Alterado Com Sucesso.'); mostra('detalharColab','filtro'); mostrar('rel_colab_fila');" />
                                        </div>
                                ...
                                <div align="right" style="width:90%;">
                                    <img src="/WebMAA/Painel_controle/ong/images/botao/bt_cancelar.png" alt="Cancelar" title="Cancelar" class="seta_link" id="cancelar" onmouseover="focoBt('cancelar');" onmouseout="bt('cancelar');" onclick="mostra('detalharColab','filtro'); mostrar('rel_colab_fila');" />&nbsp;&nbsp;
                                </div>
...
<!-- RodapÃ© -->
    ...
    <!-- Modal -->
    <div id="boxes">
        <!-- Janela Modal com caixa de diÃ¡logo (NOTIFICAÃ‡Ã•ES)-->
        ...
        <div id="notificar" class="window">
            ...
            <div class="cont_modal">
                ...
                <div id="conteudoDetalhe">
                    ...
                    <br />
                    <div align="center">
                        <img src="/WebMAA/Painel_controle/ong/images/botao/bt_enviar.png" alt="Enviar" title="Enviar" class="seta_link close" id="enviar" onmouseover="focoBt('enviar');" onmouseout="bt('enviar');" onclick="mostrar('confNote');" />
                    </div>
                    ...
                    <div align="right">
                        <img src="/WebMAA/Painel_controle/ong/images/botao/fechar.png" alt="Fechar" title="Fechar Janela" class="seta_link close" />
                    </div>
        ...
        <!-- Fim Janela Modal com caixa de diÃ¡logo (NOTIFICAÃ‡Ã•ES) -->

                    <!-- Janela Modal com caixa de diÃ¡logo (CANIL FILA DE ADOÃ‡ÃƒO)-->
        ...
        <div id="conf_del" class="window">
            ...
            <div class="cont_modal">
                ...
                <div id="conteudoDetalhe">
                    ...
                    <img src="/WebMAA/Painel_controle/ong/images/botao/alert.png" /> &nbsp;&nbsp; <span class="obrigatorio">VocÃª estÃ¡ prestes a excluir este animal do cadastro!</span>
                    <br />
                    <table class="grid" style=" width:98%;">
                        <tr>
                            <td width="26%" align="right"><font style="color:#F00;">*</font> Motivo da ExclusÃ£o: &nbsp;</td>
                            <td width="74%">
                                <select>
                                    <option></option>
                                    <option>Base de Dados</option>
                    ...
                    <br />
                    <div align="center">
                        <img src="/WebMAA/Painel_controle/ong/images/botao/bt_ok.png" alt="ok" title="Ok" class="seta_link close" id="ok" onmouseover="focoBt('ok');" onmouseout="bt('ok');" />
                    </div>
        ...
        <!-- Fim Janela Modal com caixa de diÃ¡logo (CANIL FILA DE ADOÃ‡ÃƒO) -->

                    <!-- Janela Modal com caixa de diÃ¡logo (COLABORADOR ADOTADOS)-->
                    ...
                    <div id="dadosUsuario" style="width:400px;">
                        <table class="grid">
                            ...
                            <tr>
                                ...
                                <td width="63%" valign="top"><span>JosÃ© Fulano</span></td>
                            </tr>
                        </table>
        ...
        <!-- Fim Janela Modal com caixa de diÃ¡logo (COLABORADOR ADOTADOS) -->
