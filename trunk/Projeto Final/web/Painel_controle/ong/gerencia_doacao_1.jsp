        ...
        <div id="conteudo">
            ...
            <!-- DADOS DO ANIMAL -->
                                ...
                                <div id="confNote" class="esconde" style="color:#060;">
                                    <img src="/WebMAA/Painel_controle/ong/images/botao/aprova.png" />&nbsp;&nbsp; Notificação Enviada Com Sucesso!
                                </div>
                                <br />
                                <br />
                                ...
                                <div id="cont_aba" style="padding-left:nome;">
                                    ...
                                    <div id="dadosGerais_usr" class="abaEsconde">
                                        ...
                                        <div align="right" style="width:90%;">
                                            ...
                                            <img src="/WebMAA/Painel_controle/ong/images/botao/bt_avancar.png" alt="Proximo" title="Avançar" class="seta_link" onclick="contAba('dadosComplementares_usr','dadosC_usr');" />
                                        </div>
                 ...
                 <!-- ABA DADOS COMPLEMENTARES -->
                                    <div id="dadosComplementares_usr" class="abaEsconde">
                                        ...
                                        <div align="right" style="width:90%;">
                                            ...
                                            <img src="/WebMAA/Painel_controle/ong/images/botao/bt_avancar.png" alt="Proximo" title="Avançar" class="seta_link" onclick="contAba('dadosObservacao_usr','obs_usr');" />
                                        </div>
        ...
        <div id="conf_del" class="window">
            ...
            <div class="cont_modal">
                ...
                <div id="conteudoDetalhe">
                    ...
                    <img src="/WebMAA/Painel_controle/ong/images/botao/alert.png" /> &nbsp;&nbsp; <span class="obrigatorio">Você está prestes a excluir este animal do cadastro!</span>
                    <br />
                    <table class="grid" style=" width:98%;">
                        <tr>
