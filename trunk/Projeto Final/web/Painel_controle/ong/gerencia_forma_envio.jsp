        ...
        <script type="text/javascript">
            function confirma(codigo) {
                if (window.confirm("Confirma exclusão?")) {
                    window.location = "/WebMAA/ControleFormaEnvioServlet?operacao=FormaEnvioApaga&codigo=" + codigo;
                }
            }
        ...
        <div id="corpo">
                ...
                <div class="imgBase_sem_coluna">
                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <div class="lista">
                                <div class="bordaFaixaLeft"><span>Manutenção de Entrega</span></div>
                                <br />
                                <!-- FILTRO DE PESQUISA -->
                                <div id="filtro">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            ...
                                            <td width="76%" align="center" class="grid_titulo">Forma de Entrega</td>
                                            <td width="9%" align="center" class="grid_titulo">Alterar</td>
                                            <td width="9%" align="center" class="grid_titulo">Excluir</td>
                                        </tr>
                                        <c:forEach items="${lstFormaEnvios}" var="lstFormaEnvios">
                                           <tr>
                                                <td align="center">
                                                        ${lstFormaEnvios.codigo}

                                                </td>
                                                <td>${lstFormaEnvios.descricao} </td>
                                                <td align="center">
                                                    <a href="/WebMAA/ControleFormaEnvioServlet?operacao=FormaEnvioEdita&codigo=${lstFormaEnvios.codigo}" onclick="mostra('','alterar');" >
                                                ...
                                                <td align="center"><img src="/WebMAA/Painel_controle/ong/images/botao/close.png" alt="Excluir" title="Excluir" class="seta_link" onclick="confirma(${lstFormaEnvios.codigo});" /></td>
                                            </tr>
                                        </c:forEach>
            ...
            <!-- RESULTADO DA PESQUISA-->
                                <div id="resultado" class="esconde">
                                   <div class="nota_destaque" style="width:100%;">Incluir Nova Forma de Envio</div>
                                <br />
                                <form id="frmincluirformaenvio" action="/WebMAA/ControleFormaEnvioServlet" method="post" >
                                    <input type="hidden" name="operacao" value="FormaEnvioNovoProcessa">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            <td width="19%" align="right">Forma de Envio: &nbsp;</td>
                                    ...
                                    <div align="center">
                                       <!--input type="submit"  src="/WebMAA/Painel_controle/ong/images/botao/bt_incluir.png" alt="Incluir"  name="Incluir"  title="Incluir" class="seta_link"-->
                                            <a href="javascript:document.getElementById('frmincluirformaenvio').submit();">
                                                <img src="/WebMAA/Painel_controle/ong/images/botao/bt_incluir.png" alt="Incluir" title="Incluir" class="seta_link" onclick="alert('Forma de Envio Cadastrada com sucesso!');" />
                                            </a>
                                    </div>
                                </form>
                                </div>
            ...
            <!-- Alterar Raças -->
                             <c:if test="${editarFormaEnvios.codigo == 0}">
                            ...
                            <c:if test="${editarFormaEnvios.codigo != 0}">
                                <div id="alterar" class="mostra">
                                  ...
                                  <div class="nota_destaque">Alterar Forma de Envio</div>
                                    <br />
                                    <form id="frmeditarformaenvio" action="/WebMAA/ControleFormaEnvioServlet" method="post" >
                                        <input type="hidden" name="operacao" value="FormaEnvioEditaProcessa">
                                        <input type="hidden" name="codigo" id="codigo" value="${editarFormaEnvios.codigo}">
                                        <table class="grid" style="width:100%;">
                                            <tr>
                                                <td width="19%" align="right">Forma de Envio: &nbsp;</td>
                                                <td width="81%"><input type="text" size="30" name="descricao" id="descricao" value="${editarFormaEnvios.descricao}" /></td>
                                            </tr>
                                        </table>
