        ...
        <script type="text/javascript">
            function confirma(codigo) {
                if (window.confirm("Confirma exclusÃ£o?")) {
                    window.location = "/WebMAA/ControleUFServlet?operacao=UFApaga&codigo=" + codigo;
                }
            }
        ...
        <div id="corpo">
                ...
                <div class="imgBase_sem_coluna">
                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <div class="lista">
                                <div class="bordaFaixaLeft"><span>Manutenção de UF</span></div>
                                <br />
                                <!-- FILTRO DE PESQUISA -->
                                <div id="filtro">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            ...
                                            <td width="76%" align="center" class="grid_titulo">Tipo da UF</td>
                                        ...
                                        <c:forEach items="${lstUF}" var="lstUF">
                                           <tr>
                                                ...
                                                <td>${lstUF.UF} </td>
                                                <td align="center">
                                                    <a href="/WebMAA/ControleUFServlet?operacao=UFEdita&codigo=${lstUF.codigo}" onclick="mostra('','alterar');" >
                                                ...
                                                <td align="center"><img src="/WebMAA/Painel_controle/ong/images/botao/close.png" alt="Excluir" title="Excluir" class="seta_link" onclick="confirma(${lstUF.codigo});" /></td>
                                            </tr>
                                        </c:forEach>
            ...
            <!-- RESULTADO DA PESQUISA-->
                                <div id="resultado" class="esconde">
                                   <div class="nota_destaque" style="width:100%;">Incluir Nova UF</div>
                                <br />
                                <form id="frmincluirUF" action="/WebMAA/ControleUFServlet" method="post" >
                                    <input type="hidden" name="operacao" value="UFNovoProcessa">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            <td width="19%" align="right">Tipo da UF: &nbsp;</td>
                                    ...
                                    <div align="center">
                                       <!--input type="submit"  src="/WebMAA/Painel_controle/ong/images/botao/bt_incluir.png" alt="Incluir"  name="Incluir"  title="Incluir" class="seta_link"-->
                                           <a href="javascript:document.getElementById('frmincluirUF').submit();">
            ...
            <!-- Alterar Raças -->
                            ...
                            <c:if test="${editarUF.codigo != 0}">
                                <div id="alterar" class="mostra">
                                  ...
                                  <div class="nota_destaque">Alterar UF</div>
                                    <br />
                                    <form id="frmeditarUF" action="/WebMAA/ControleUFServlet" method="post" >
                                        <input type="hidden" name="operacao" value="UFEditaProcessa">
                                        <input type="hidden" name="codigo" id="codigo" value="${editarUF.codigo}">
                                        <table class="grid" style="width:100%;">
                                            <tr>
                                                <td width="19%" align="right">Tipo da UF: &nbsp;</td>
                                                <td width="81%"><input type="text" size="30" name="descricao" id="descricao" value="${editarUF.UF}" /></td>
                                            </tr>
                                        </table>
                                        ...
                                        <div align="center" style="width:90%;">
                                            ...
                                            <a href="javascript:document.getElementById('frmeditarUF').submit();">
