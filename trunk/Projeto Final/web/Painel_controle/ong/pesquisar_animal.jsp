                                        ...
                                        <c:forEach  items="${lstAnimais}" var="lstAnimais">
                                            ...
                                            <tr>
                                                ...
                                                <c:if test="${lstAnimais.codigoColaborador!=0}">
                                                  ...
                                                  <td align="center" ><img  src="/WebMAA/Painel_controle/ong/images/botao/document_edit.png" alt="Alterar" title="Alterar" class="seta_link" onclick="alert('Ops!Dados do animal do colaborador ṇo pode ser alterado.');"  /></td>
                                                  <td align="center"><img src="/WebMAA/Painel_controle/ong/images/botao/close.png" alt="Excluir" title="Excluir" class="seta_link" onclick="alert('Ops!Dados do animal do colaborador ṇo pode ser excluido.');" /></td>
                                                </c:if>
                                            </tr>
