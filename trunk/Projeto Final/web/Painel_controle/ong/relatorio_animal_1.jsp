                                ...
                                <div id="rel_canil_adotado" class="esconde">
                                    ...
                                    <table class="grid">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">JosÃ© Sicrano</td>
...
<!-- RodapÃ© -->
        ...
        <!-- Modal -->
        <div id="boxes">
            <!-- Janela Modal com caixa de diÃ¡logo (ADOTADOS CANIL)-->
            ...
            <!-- Fim Janela Modal com caixa de diÃ¡logo (COLABORADOR ADOTADOS) -->
                    ...
                    <!-- Janela Modal com caixa de diÃ¡logo (COLABORADOR FILA)-->
            ...
            <!-- Fim Janela Modal com caixa de diÃ¡logo (COLABORADOR FILA) -->
