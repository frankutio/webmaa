                            ...
                            <div class="lista">
                                ...
                                <c:if test="${lstProcesso == null}">
                                 ...
                                 <c:if test="${lstProcesso != null && detalheAdotados.codigo==0}">
                                    <div id="rel_canil_fila" class="mostra">
                                </c:if>
                                <c:if test="${lstProcesso != null && detalheAdotados.codigo!=0}">
                                    <div id="rel_canil_fila" class="esconde">
                                </c:if>
                                    ...
                                    <table class="grid" style="width:100%;">
                                        ...
                                        <tr>
                                           ...
                                           <td align="center">${lstProcesso.especie}</td>
                                            ...
                                            <td align="center">
                                                <a href="/WebMAA/ControleAnimaisServlet?operacao=AnimaisMostraFilaCanil&codigoanimal=<c:out value="${lstProcesso.codigo}"></c:out>" onclick="mostra('rel_canil_fila','canil_fila');">
                                ...
                                <c:if test="${detalheAdotados.codigo==0}">
                                    <div id="canil_fila" class="esconde">
                                </c:if>
                                <c:if test="${detalheAdotados.codigo!=0}">
                                    <div id="canil_fila" class="mostra">
                                </c:if>
                                    
                                    <div class="nota_destaque" style="width:100%;">Animal na Fila de Adoção</div>
                                    <br />
                                ...
                                <!-- DADOS DO ANIMAL -->
                                    ...
                                    <br />
                                    <div align="right">
                                        <img src="/WebMAA/Painel_controle/ong/images/botao/bt_voltar.png" alt="Voltar" title="Voltar" class="seta_link"  onclick="mostra('canil_fila','rel_canil_fila');"/>
                                    </div>
                                    <br />
