...
<div id="colunaLeft_geral">
          ...
          <div id="dadosInicio">
              <br />
                ...
                <table class="grid" style="width:100%; border-bottom:solid #CCC 1px;">
                	<tr>
                   	  <td width="16%" align="right" valign="top"><img src="/WebMAA/images/noticias/capa.png" alt="Foto de um Gato: Fique atento ao calendário e proteja seu animal de estimação." width="71" height="72" title="Fique atento ao calendário e proteja seu animal de estimação."  /> &nbsp;
                        </td>
                        <td width="84%" valign="middle">
                        	<a href="/WebMAA/noticia/vacinacao/vacinacao.jsp">Fique atento ao calendário e proteja seu animal de estimação.</a>
                        </td>
                  </tr>
                </table>
