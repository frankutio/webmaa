...
<div id="colunaLeft_geral">
			<div class="bordaFaixaPainel_left"><span><img src="/images/botao/ico_painel.png" alt="Painel" title="" style=" float:left; text-align:left; padding-right:5px;" /> Acompanhar Ado��o - &nbsp;&nbsp; Painel de Controle</span></div>
                <br />          
            ...
            <div id="cont_painel">
                ...
                <div class="bloco_centro">
					...
					<br />
						...
						Ado��o não é brincadeira, é coisa a ser levado a serio. <br />
						<br />
				...
				<div id="comunicacao" class="esconde">
					...
					<table class="grid" style="width:100%;">
						<tr>
							...
							<td class="grid_titulo" align="center">Endere�o</td>
...
<table class="grid">
                                    ...
                                    <tr>
                                    	<td width="38%" align="right">Você Recebeu o seu animal? &nbsp;</td>
                                    ...
                                    <tr id="motivo_entrega" class="esconde">
                                    	<td colspan="2">
                                        <table class="grid" style="width:100%;">
                                        	<tr>
                                    ...
                                    <tr>
                                    	<td colspan="2">Conte para agante como foi a sau experiencia com o Ex-proprietario:</td>
                                    </tr>
                                    <tr>
                                    	<td colspan="2"><textarea rows="5" cols="60" disabled="disabled" id="coment"></textarea></td>
                                    </tr>
                               </table>
                               </form>  
                               ...
                               <table class="grid">
                               		<tr>
                                    	<td width="8%"><img src="/images/botao/alert.png" alt="Atenção" /></td>
