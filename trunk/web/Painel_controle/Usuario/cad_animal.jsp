...
<div id="colunaLeft_geral">
            ...
            <div id="dadosUsuario">
             ...
             <br />
                ...
                <P>
                	Atravez deste canal vocÃª pode oferecer o seu animal para doaÃ§Ã£o, A Ong Amigos Fieis nÃ£o Ã© a responsavel por adoÃ§Ãµes de animais que estÃ£o fora do nosso Gatil/Canil.<br />
                </P>
          </div>            
            <!-- DADOS DO USUARIO -->
            ...
            <div id="cont_painel">
                ...
                <div class="bloco_centro">
                	Nota que para criterios de doaÃ§Ã£o a Ong NÃO se responsabiliza pela saude do animal, sendo que o mesmo deve ter o Laudo Veterinario.
                    <br />
                    <br />
