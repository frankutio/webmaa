...
$(function() {
	...
	$(".cancelar").mouseover(function() {
		$(this).attr("src", "/WebMAA/Painel_controle/Usuario/images/botao/bt_desistir_light.png");
	});

	$(".cancelar").mouseout(function() {
		$(this).attr("src", "/WebMAA/Painel_controle/Usuario/images/botao/bt_desistir.png");
	});
	...
	$(".desistir").mouseout(function() {
		$(this).attr("src", "/WebMAA/Painel_controle/Usuario/images/botao/bt_desistir_desabilitado.png");
	});
            ...
            <table class="grid" style="width:95%;">
                    ...
                    <c:if test="${Processo.faseProcesso == 1}">
                        <div align="right" style="width:95%;">
                            <a href="/WebMAA/gerProcesso?operacao=cancela_processo_usuario&codigo=${Processo.codigo}&codAnimal=${Animal.codigo}&codigoColab=${Colaborador.codigo}"><img src="/WebMAA/Painel_controle/Usuario/images/botao/bt_desistir.png" class="seta_link cancelar" /></a>
                        </div>
                    </c:if>
                    ...
                    <div id="fase02">
							...
							<tr>
								...
								<td width="72%">
                                    <c:if test="${Processos.faseProcesso == 4}">
                                        <span id="fase2_completa"><img src="/WebMAA/Painel_controle/Usuario/images/botao/aprova.png" /> &nbsp;Concluida!</span>
                                    </c:if>
                               </td>
							</tr>
						</table>
                        ...
                        <c:if test="${Processo.faseProcesso == 2}">
                                O que Pretendes Fazer?
                                     <div align="right" style="width:95%;">
                                         <a href="/WebMAA/gerProcesso?operacao=confirma_processo_adocao&codigo=${Processo.codigo}&fase=3&codAnimal=${Animal.codigo}&codigoColab=${Animal.codigoUsuario}&codigoUsr=${Colaborador.codigo}"><img src="/WebMAA/Painel_controle/Usuario/images/botao/bt_continuar.png" alt="Continuar" title="Continuar" class="seta_link continua" /></a>&nbsp;&nbsp;
                                         <a href="/WebMAA/gerProcesso?operacao=cancela_processo_usuario&codigo=${Processo.codigo}&codAnimal=${Animal.codigo}&codigoColab=${Colaborador.codigo}"><img src="/WebMAA/Painel_controle/Usuario/images/botao/bt_desistir_desabilitado.png" alt="cancelar adoção" title="Cancelar Adoção" class="seta_link desistir" /></a>
                                     </div>
                         </c:if>
                       <br />
