...
<div id="colunaLeft_geral">
			<div class="bordaFaixaPainel_left"><span><img src="/WebMAA/Painel_controle/Usuario/images/botao/ico_painel.png" alt="Painel" title="" style=" float:left; text-align:left; padding-right:5px;" /> Avaliar Adoções &nbsp;&nbsp; - &nbsp;&nbsp; Painel de Controle</span></div>
                <br />

            <c:if test="${Animais == null}">
                <div class="nota_informa">
                    <span>Você não processos para avaliar até o momento.</span>
                </div>
            </c:if>
            <c:if test="${Animais != null}">
                <p>
                	Para avaliar um processo, clique no botão correspondente ao animal que você gostaria de "Avaliar".

                </p>

                <br />
                <div class="nota_destaque">Lista de Animais com Avaliação pendente.</div>
                <br />
                ...
                <table class="grid" style="width:80%;">
                    ...
                    <c:forEach items="${Animais}" var="Animal">
                        <tr class="td_escura">
                            ...
                            <td align="center"><a href="/WebMAA/gerProcesso?operacao=detalhar_avaliacao&cod_animal=${Animal.codigo}"><img src="/WebMAA/Painel_controle/Usuario/images/botao/bt_exibir.png" align="Exibir" title="Exibir" class="seta_link botaoExibir" /></a></td>
                        </tr>
                   </c:forEach>
                </table>
