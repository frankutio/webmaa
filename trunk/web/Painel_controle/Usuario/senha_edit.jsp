                		...
                		<table class="grid">
                          ...
                          <tr>
                    			<td width="32%" align="right"><span class="obrigatorio">*</span> Lembrete de Senha: &nbsp;</td>
                              	<td><input type="text" name="lembrete" value="Minha Ṃe" size="30" /></td>
                   		  </tr>
               			</table>
               	</fieldset>
                <br />
             ...
             <div class="bordaFaixaLeft"><span>Doa̤̣o</span></div>
               ...
               <table class="grid">
                 ...
                 <tr>
                    ...
                    <a href="cad_animal.html"><img src="/images/botao/bt_doar.png" alt="Cadatrar Animal Para Doa̤̣o" title="Cadatrar Animal Para Doa̤̣o" class="seta_link" id="doar" onmouseover="focoBt('doar');" onmouseout="bt('doar');" /></a></td>
                 </tr>
               </table> 
