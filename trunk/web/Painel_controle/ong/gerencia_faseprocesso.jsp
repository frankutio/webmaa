        ...
        <script type="text/javascript">
            function confirma(codigo) {
                if (window.confirm("Confirma exclusÃ£o?")) {
                    window.location = "/WebMAA/ControleFaseProcessoServlet?operacao=FaseProcessoApaga&codigo=" + codigo;
                }
            }
        ...
        <div id="corpo">
                ...
                <div class="imgBase_sem_coluna">
                    ...
                    <div id="cont">
                        ...
                        <div class="conteudo_painel">
                            ...
                            <div class="lista">
                                <div class="bordaFaixaLeft"><span>Manutenção da Fase Processo</span></div>
                                <br />
                                <!-- FILTRO DE PESQUISA -->
                                <div id="filtro">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            ...
                                            <td width="76%" align="center" class="grid_titulo">Tipo da FaseProcesso</td>
                                            <td width="9%" align="center" class="grid_titulo">Alterar</td>
                                            <td width="9%" align="center" class="grid_titulo">Excluir</td>
                                        </tr>
                                        <c:forEach items="${lstFaseProcesso}" var="lstFaseProcesso">
                                           <tr>
                                                <td align="center">
                                                        ${lstFaseProcesso.codigo}

                                                </td>
                                                <td>${lstFaseProcesso.descricao} </td>
                                                <td align="center">
                                                    <a href="/WebMAA/ControleFaseProcessoServlet?operacao=FaseProcessoEdita&codigo=${lstFaseProcesso.codigo}" onclick="mostra('','alterar');" >
                                                ...
                                                <td align="center"><img src="/WebMAA/Painel_controle/ong/images/botao/close.png" alt="Excluir" title="Excluir" class="seta_link" onclick="confirma(${lstFaseProcesso.codigo});" /></td>
                                            </tr>
                                        </c:forEach>
            ...
            <!-- RESULTADO DA PESQUISA-->
                                <div id="resultado" class="esconde">
                                   <div class="nota_destaque" style="width:100%;">Incluir Nova Fase Processo</div>
                                <br />
                                <form id="frmincluirFaseProcesso" action="/WebMAA/ControleFaseProcessoServlet" method="post" >
                                    <input type="hidden" name="operacao" value="FaseProcessoNovoProcessa">
                                    <table class="grid" style="width:100%;">
                                        <tr>
                                            <td width="19%" align="right">Tipo da Fase Processo: &nbsp;</td>
                                    ...
                                    <div align="center">
                                       <!--input type="submit"  src="/WebMAA/Painel_controle/ong/images/botao/bt_incluir.png" alt="Incluir"  name="Incluir"  title="Incluir" class="seta_link"-->
                                           <a href="javascript:document.getElementById('frmincluirFaseProcesso').submit();">
                                           <img src="/WebMAA/Painel_controle/ong/images/botao/bt_incluir.png" alt="Incluir" title="Incluir" class="seta_link" onclick="alert('Unidade cadastrada com sucesso!');" />
                                           </a>
                                    </div>
                                </form>
                                </div>
            ...
            <!-- Alterar Raças -->
                            ...
                            <c:if test="${editarFaseProcesso.codigo != 0}">
                                <div id="alterar" class="mostra">
                                  ...
                                  <div class="nota_destaque">Alterar FaseProcesso</div>
                                    <br />
                                    <form id="frmeditarFaseProcesso" action="/WebMAA/ControleFaseProcessoServlet" method="post" >
                                        <input type="hidden" name="operacao" value="FaseProcessoEditaProcessa">
                                        <input type="hidden" name="codigo" id="codigo" value="${editarFaseProcesso.codigo}">
                                        <table class="grid" style="width:100%;">
                                            <tr>
                                                <td width="19%" align="right">Tipo da FaseProcesso: &nbsp;</td>
                                                <td width="81%"><input type="text" size="30" name="descricao" id="descricao" value="${editarFaseProcesso.descricao}" /></td>
                                            </tr>
                                        </table>
                                        ...
                                        <div align="center" style="width:90%;">
                                            ...
                                            <a href="javascript:document.getElementById('frmeditarFaseProcesso').submit();">
                                            <img src="/WebMAA/Painel_controle/ong/images/botao/bt_alterar.png" alt="Alterar" title="Alterar" class="seta_link" onclick="alert('Fase do Processo Alterada com Sucesso');" />&nbsp;&nbsp;
                                            </a>
                                        </div>
                                    </form>
                                </div>
