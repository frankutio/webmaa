...
<c:forEach items="${lstAnimal}" var="lstAnimal">
         ...
         <div class="listaAnimal">
               <span>
               <a href="/WebMAA/listaAnimal?operacao=detalhar_cao&codigo=${lstAnimal.codigo}"><img src="/WebMAA/${lstAnimal.especie}/images/miniaturas/${lstAnimal.endFoto}" alt="${lstAnimal.nome}" title="${lstAnimal.nome}" class="seta_link" /></a>
               </span>
                ${lstAnimal.descricao}
                <br />
                <br />
                <c:if test="${lstAnimal.localAnimal == 'Sim'}">
                    <div class="obrigatorio"> <img src="/WebMAA/images/ico_canil.png" alt="Em Canil" /> &nbsp; Animal em nosso Gatil e está garantido pela Ong.</div>
                </c:if>
