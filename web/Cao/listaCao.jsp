...
<script>
function focoBt(id){
		$("#"+id).attr("src","/mages/botao/bt_logoff_light.png");
}
...
<div id="colunaLeft_geral">
			<div class="bordaFaixaLeft"><span>Lista de C&atilde;es para Ado&ccedil;&atilde;o</span></div>
                <br />
...
<span class="obrigatorio">Nenhum Cachorro Cadastrado para Adoção!</span>
</c:if>
...
<c:forEach items="${lstAnimal}" var="lstAnimal">
         ...
         <div class="listaAnimal">
               <span>
               <a href="/listaAnimal?operacao=detalhar_cao&codigo=${lstAnimal.codigo}"><img src="/${lstAnimal.especie}/images/miniaturas/${lstAnimal.endFoto}" alt="${lstAnimal.nome}" title="${lstAnimal.nome}" class="seta_link" /></a>
               </span>
                ${lstAnimal.descricao}
                <br />
                <br />
            ...
            <c:if test="${Log.login == null}">
            	...
            	<div class="login">
                    ...
                    <form action="/NavUsr" name="logar" method="post" class="link">
                        ...
                        <input type="hidden" name="dispara" value="listaAnimal?operacao=lista_cao" />
