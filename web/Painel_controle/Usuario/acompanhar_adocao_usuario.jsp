...
<div id="colunaLeft_geral">
   	    ...
   	    <table class="grid" style="width:95%;">
                    ...
                    <div class="nota_informa" style="width:90%;">
                    	<span>Animal aguardando aprova̤̣o por parte do proprietario. Voc̻ ainda pode desistir da ado̤̣o clicando no botao acima.</span>
                    </div>
          </div>            
            <!-- DADOS DO USUARIO -->
            ...
            <!-- LOGIN -->
             ...
             <div class="bordaFaixaLeft"><span>Acompanhar</span></div>
			   ...
			   <table class="grid esconde" id="perfil">
					<tr>
						<td colspan="2" align="center"><a href="acompanhar_adocao_usuario2.html">Fase 2</a></td>
					</tr>
					<tr>
