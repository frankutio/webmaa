...
function focoBt(id){
		...
		$("#"+id).attr("src","/Painel_controle/Usuario/images/botao/bt_ok_light.png");
	}
}
...
function bt(id){
		...
		$("#"+id).attr("src","/Painel_controle/Usuario/images/botao/bt_ok.png");
	}
}
...
<div id="colunaLeft_geral">
			<div class="bordaFaixaPainel_left"><span><img src="/Painel_controle/Usuario/images/botao/ico_painel.png" alt="Painel" title="" style=" float:left; text-align:left; padding-right:5px;" /> Bem Vindo  - &nbsp;&nbsp; Painel de Controle</span></div>
                <br />          
            ...
            <div id="dadosUsuario">
                ...
                if(request.getAttribute("Altera") != null){
                    out.print("<br />" +
                     "<span style='color:#090;'> <img src='/Painel_controle/Usuario/images/botao/aprova.png' />" +
   	    ...
   	    <table class="grid">
                        ...
                        <tr>
                            ...
                            <td width="76%">
                                    &nbsp; <a href="/gerProcesso?operacao=ver_avaliacao&cod_colaborador=${Colaborador.codigo}">Processo(s) para Avaliação</a>
                             </td>
                             </c:if>
                        </tr>
                    </table>
            ...
            <div id="cont_painel">
            	<div class="bloco_left">
                 ...
                 <table class="grid">
                    <c:if test="${empty Msg}">
                        <tr>
                        	<td width="29%" align="right"><img src="/Painel_controle/Usuario/images/botao/ico_email.png" alt="Mensagem" title="Ver Mensagem" />&nbsp;</td>
                            <td width="71%">Nenhuma Mensagem</td>
                        </tr>
                     </c:if>
                     <c:if test="${!empty Msg}">
                       <tr>
                        	<td width="29%" align="right"><a href="#mensagem" name="modal"><img src="/Painel_controle/Usuario/images/botao/ico_email.png" alt="Mensagem" title="Ver Mensagem" class="seta_link" /></a> &nbsp;</td>
          ...
          <br />          
            ...
            <!-- LOGIN -->
              ...
              <table class="grid">
                        <tr>
                        	<td width="29%" align="right"><a href="/Painel_controle/Usuario/cad_edit.jsp"><img src="/Painel_controle/Usuario/images/botao/editar.png" alt="Alterar Cadastro" title="Alterar Cadastro" class="seta_link" /></a> &nbsp;</td>
             ...
             <div class="bordaFaixaLeft"><span>Acompanhar</span></div>
               ...
               <table class="grid">
               		<tr>
                    	<td><img src="/Painel_controle/Usuario/images/botao/ico_acmp.png" alt="Ver Adoção" title="Acompanhar Adoção" class="seta_link"  /></td>
                        <td><a href="/gerProcesso?operacao=ver_adocao&cod_colaborador=${Colaborador.codigo}">Acompanhar Ado&ccedil;&atilde;o</a></td>
                    </tr>
                    <tr>
                    	<td><img src="/Painel_controle/Usuario/images/botao/ico_acmp.png" alt="Ver Adoção" title="Acompanhar Adoção" class="seta_link"  /></td>
                        <td><a href="/gerProcesso?operacao=listar_animais&cod_colaborador=${Colaborador.codigo}">Acompanhar Doa&ccedil;&otilde;es</a></td>
                    </tr>
				</table>				
               <br />
             <div class="bordaFaixaLeft"><span>Doa&ccedil;&atilde;o</span></div>
               ...
               <table class="grid">
                   <c:if test="${empty listaAnimal}">
                       <tr>
                    	<td valign="top"><img src="/Painel_controle/Usuario/images/botao/alert.png" alt="alerta" title="alerta" /></td>
                    ...
                    <a href="/GerAnimal?operacao=iniciar_cad"><img src="/Painel_controle/Usuario/images/botao/bt_doar.png" alt="Cadatrar Animal Para Doação" title="Cadatrar Animal Para Doação" class="seta_link" id="doar" onmouseover="focoBt('doar');" onmouseout="bt('doar');" /></a></td>
                 </tr>
                   </c:if>
                   <c:if test="${!empty listaAnimal}">
                       <tr>
  						...
  						<div class="cont_modal">                        	
                            ...
                            <!-- DETALHES DA MENSAGEM -->
                                <div id="conteudoDetalhe">
                                    ...
                                    <form name="altFoto" action="PainelControle?operacao=alterar_foto&codigo=${Colaborador.codigo}" method="post" enctype="multipart/form-data">
                                     ...
                                     <table class="grid" style="font-size:14px;">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                        	<td colspan="2" align="center">
                                            <input type="image" src="/Painel_controle/Usuario/images/botao/bt_ok.png" alt="Ok" title="Ok" class="seta_link" id="ok" onmouseover="focoBt('ok');" onmouseout="bt('ok');" />
                                           </td>
                                        </tr>
                                     </table>
                    				</form>
                                    ...
                                    <div align="right">
                                    	<img src="/Painel_controle/Usuario/images/botao/fechar.png" alt="Fechar" title="Fechar Janela" class="seta_link close" />
                                    </div>
                    					...
                    					<table class="grid" style=" width:98%;">
                                          ...
                                          <c:forEach items="${Msg}" var="Not">
                                              <tr class="td_escura">
                                                ...
                                                <td align="center"><a href="Mensagem?operacao=apagaMsg&codigoMsg=${Not.codigo}&colaborador=${Not.codigoColaborador}&dispara=painel"><img src="/Painel_controle/Usuario/images/botao/ico_delete.png" alt="Excluir" title="Excluir" class="seta_link" /></a></td>
                                             </tr>
                                          </c:forEach>  
                                        </table>
                                     <br />
                                ...
                                <div id="conteudoDetalhe">
                                    ...
                                    <br />
                                     ...
                                     <table class="grid" style="width:90%;" align="center">
                                      ...
                                      <tr class="td_escura">
                                            <td align="center"><img src="/${Animal.especie}/images/miniaturas/${Animal.endFoto}" alt="${Animal.nome}" width="69" height="59" title="${Animal.nome}" /></td>
                                            ...
                                            <td align="center"><a href="/GerAnimal?operacao=exibir_dados_animal&codigo=${Animal.codigo}"><img src="/Painel_controle/Usuario/images/botao/editar.png" alt="Editar" title="Editar" class="seta_link" /></a></td>
                                            <td align="center"><img src="/Painel_controle/Usuario/images/botao/close.png" alt="Excluir" title="Excluir" class="seta_link" onclick="confirmaExclusao('${Animal.codigo}');" /></td>
                                        </tr>
                                       </c:forEach>
                    				</table>
