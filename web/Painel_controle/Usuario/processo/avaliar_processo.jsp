...
<div id="colunaLeft_geral">
			<div class="bordaFaixaPainel_left"><span><img src="/WebMAA/Painel_controle/Usuario/images/botao/ico_painel.png" alt="Painel" title="" style=" float:left; text-align:left; padding-right:5px;" /> Avaliar Ado&ccedil;&atilde;o - &nbsp;&nbsp; Painel de Controle</span></div>
                <br />
                     ...
                     <br />
                      <br />
                       <div id="fase03">
                        ...
                        <form name="faseForm" method="post" action="/WebMAA/gerProcesso" onsubmit="return false">
                            ...
                            <table class="grid">
                               ...
                               <table class="grid">
                               		<tr>
                                    	<td width="8%"><img src="/WebMAA/Painel_controle/Usuario/images/botao/alert.png" alt="Atenção" /></td>
                               ...
                               <div align="center" style="width:90%;">
                					<input type="image" src="/WebMAA/Painel_controle/Usuario/images/botao/bt_positiva.png" alt="Positiva" title="Positiva" disabled="disabled" value="positiva" class="avaliar" /> &nbsp;&nbsp;
                                    <input type="image" src="/WebMAA/Painel_controle/Usuario/images/botao/bt_negativa.png" alt="Negativa" title="Negativa" disabled="disabled" value="negativa" class="avaliar" />
                				</div>
                                </div>
