...
<script type="text/javascript" src="/js/preenche_animal.js"></script>
...
<table class="grid">                	
            ...
            <div style="width:70%; text-align:right;">
              <input type="image" src="/images/botao/bt_continuar_verde.png" alt="ok" title="Continuar" class="seta_link" id="continuar" onmouseover="focoBt('continuar');" onmouseout="bt('continuar');" />
              &nbsp;&nbsp;
                <img src="/images/botao/bt_limpar.png" alt="Limpar" title="limpar" id="limpar" onmouseover="focoBt('limpar');" onmouseout="bt('limpar');" onclick="document.cadastro.reset();" class="seta_link" />&nbsp;&nbsp;
                <img src="/images/botao/bt_voltar.png" alt="Voltar" title="Voltar" class="seta_link" onclick="history.back();"  />
