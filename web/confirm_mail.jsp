  ...
  <div id="conf_envio">
      ...
      <br />
              ...
              <div align="center" style="width:80%">
              	<img src="/WebMAA/images/botao/bt_ok.png" alt="Ok" title="ok" class="seta_link" id="ok" onmouseover="focoBt('ok');" onmouseout="bt('ok');" onclick="window.location='/WebMAA/index.jsp'" />
              </div>
          </div>
            <!-- FIM DA TELA DE CONFIRMAÇÃO -->
