          ...
          <div id="dadosInicio">
              ...
              <form name="FormContato" method="post" id="FormContato" action="Email">
                ...
                <div align="center" style="width:80%;">
                	<img src="/images/botao/bt_limpar.png" alt="Limpar" title="Limpar" class="seta_link" id="limpar" onmouseover="focoBt('limpar');" onmouseout="bt('limpar');" onclick="document.FormContato.reset();" />&nbsp;&nbsp;
                    <input type="image" src="/images/botao/bt_enviar_verde.png" alt="Enviar" title="Enviar" id="enviar" onmouseover="focoBt('enviar');" onmouseout="bt('enviar');" />
                </div>
              </form>
