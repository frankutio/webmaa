...
<div id="conteudo">
	...
	<!-- CONTEUDO AQUI -->
        ...
        <br />
                ...
                <div align="center">
                	<a href="/GerAnimal?operacao=iniciar_cad"><img src="/images/botao/bt_doar.png" alt="Doar" title="Doar Animal" class="seta_link" id="doar" onmouseover="focoBt('doar');" onmouseout="bt('doar');" /></a>
                </div>
            ...
            <div id="colunaCenter">
				...
				<a href="/noticia/vacinacao/vacinacao.jsp"><img src="/images/noticias/capa.png" style="float:left; margin-right:5px;" class="seta_link" alt="Foto de um Gato no colo do veterinário" title="Vacinação" /></a>
                <p style="color:#000;">
                	<a href="/noticia/vacinacao/vacinacao.jsp" style="text-decoration:none; color:#000;">As vacinas são muito importantes para contribuir com a saúde do animal e das pessoas. É indispensável que cães e gatos sejam vacinados anualmente contra a raiva.
...
Todos os cães ou gatos acima de 3 meses de idade devem tomar a vacina contra raiva, inclusive as fêmeas que estiverem amamentando, prenhas ou no cio. Ao vacinar o animal, o proprietário recebe um comprovante de vacinação, que é válido por 1 ano. </a>
            ...
            <a href="/final_feliz/index.jsp"><img src="/Gato/images/miniaturas/lucky.png" alt="Gato Lucky" width="75" height="64" class="seta_link" title="Lucky" style="float:left; margin-right:10px;" /></a>
            <a href="/final_feliz/index.jsp"><img src="/Gato/images/miniaturas/nanda.png" class="seta_link" width="75" height="64" style="float:left; margin-right:10px;" /></a>
            </div>
